...
def load_pretrained_swin(model, ckpt_rpath=None, state_dict=None):
    """
    zy: modified from official implementation
    """
    if state_dict is None:
        assert isinstance(ckpt_rpath, str)
        print(f"==============> Loading weight {ckpt_rpath}......")
    ...
    # print(msg)
    # print(f"=> loaded successfully '{ckpt_rpath}'")
    # del checkpoint
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 use_checkpoint=False, add_cls=True, **kwargs):
        super().__init__()
